...
extern void p35p_solver(real32_T X[12], real32_T x[4], real32_T y[4], real32_T e,
  real32_T *solution_num, real32_T f_sol_data[], int32_T f_sol_size[2], real32_T
  R_sol_data[], int32_T R_sol_size[3], real32_T T_sol_data[], int32_T
  T_sol_size[2]);

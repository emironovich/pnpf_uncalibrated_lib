...
void xzggbal(creal32_T A_data[], int A_size[2], int *ilo, int *ihi, int
    ...
    do {
      ...
      while ((!exitg3) && (ii > 0)) {
        ...
        while ((!exitg4) && (jj <= *ihi - 1)) {
          if ((A_data[(ii + A_size[0] * jj) - 1].re != 0.0F) || (A_data[(ii +
                A_size[0] * jj) - 1].im != 0.0F) || (ii == jj + 1)) {
            if (nzcount == 0) {
              j = jj;
              nzcount = 1;
              jj++;
      ...
      if (!found) {
        ...
        if (i != *ihi) {
          for (nzcount = 1; nzcount <= ii; nzcount++) {
            ...
            i18 = (*ihi + jj) - 1;
            A_data[atmp_re_tmp] = A_data[i18];
            A_data[i18].re = atmp_re;
            A_data[i18].im = atmp_im;
          }
        }
        ...
        if (j + 1 != *ihi) {
          for (nzcount = 0; nzcount < *ihi; nzcount++) {
            ...
            i18 = nzcount + A_size[0] * (*ihi - 1);
            A_data[jj] = A_data[i18];
            A_data[i18].re = atmp_re;
            A_data[i18].im = atmp_im;
          }
        }
    ...
    if (exitg2 == 1) {
      ...
      do {
        ...
        while ((!exitg3) && (jj <= *ihi)) {
          ...
          exitg4 = false;
          while ((!exitg4) && (ii <= *ihi)) {
            if ((A_data[(ii + A_size[0] * (jj - 1)) - 1].re != 0.0F) || (A_data
                 [(ii + A_size[0] * (jj - 1)) - 1].im != 0.0F) || (ii == jj)) {
              if (nzcount == 0) {
                i = ii;
                nzcount = 1;
                ii++;

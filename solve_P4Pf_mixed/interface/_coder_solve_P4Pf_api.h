...
extern void solve_P4Pf(real32_T X[12], real32_T u[4], real32_T v[4], real32_T e,
  real32_T *solution_num, real32_T fs_data[], int32_T fs_size[2], real32_T
  Rs_data[], int32_T Rs_size[3], real32_T Ts_data[], int32_T Ts_size[2]);
